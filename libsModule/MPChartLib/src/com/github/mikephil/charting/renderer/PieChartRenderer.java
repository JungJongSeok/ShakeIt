            ...
            for (int j = 0; j < entryCount; j++) {
                ...
                if (drawXOutside || drawYOutside) {
                    ...
                    if (drawXOutside && drawYOutside) {
                        ...
                        drawValue(c, formatter, (int)value, entry, 0, labelPtx, labelPty + lineHeight / 2.f, dataSet.getValueTextColor(j));
                    }
                }
                ...
                if (drawXInside || drawYInside) {
                    ...
                    if (drawXInside && drawYInside) {
                        ...
                        drawValue(c, formatter, (int)value, entry, 0, x, y, dataSet.getValueTextColor(j));
                        ...
                        drawValue(c, formatter, (int)value, entry, 0, x, y + lineHeight / 2f, dataSet.getValueTextColor(j));
                    }
                }
