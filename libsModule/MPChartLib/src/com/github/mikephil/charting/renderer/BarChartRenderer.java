            ...
            for (int i = 0; i < mChart.getBarData().getDataSetCount(); i++) {
                ...
                if (!dataSet.isStacked()) {
                    ...
                    for (int j = 0; j < valuePoints.length * mAnimator.getPhaseX(); j += 2) {
                        ...
                        drawValue(c, dataSet.getValueFormatter(), (int)val, entry, i, valuePoints[j],
                    ...
                    for (int j = 0; j < (valuePoints.length - 1) * mAnimator.getPhaseX(); j += 2) {
                        ...
                        if (vals == null) {
                            ...
                            drawValue(c, dataSet.getValueFormatter(), (int)entry.getVal(), entry, i, valuePoints[j],
                            ...
                            for (int k = 0; k < transformed.length; k += 2) {
                                ...
                                drawValue(c, dataSet.getValueFormatter(), (int)vals[k / 2], entry, i, x, y, color);
                            }
                        }
                    }
                }
